...
import { Users as UsersIcon, Shield, Trash2, Phone, Mail, Calendar } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
          ...
          <span className="text-base font-normal text-gray-400">({users.length})</span>
        </h1>
      </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3 mt-1 text-xs text-gray-500">
                    ...
                    {u.created_at && <span className="flex items-center gap-1"><Calendar size={11} />Joined {formatDate(u.created_at)}</span>}
                  </div>
                </div>
              </div>
